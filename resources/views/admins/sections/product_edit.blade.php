                        ...
                        <form action="{{route('products.update',$product->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="firstName" class="form-control" placeholder="  " name="name" value="{{ $product->product_name }}"> </div>
                                    </div>
                                    <!--/span-->
                                 <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" data-placeholder="Choose a Classification" tabindex="1" name="classification">
                                                <option value="{{ $product->classification->id }}">{{ $product->classification->class_name }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="price" aria-label="price" aria-describedby="basic-addon1" name="price" value="{{ $product->price }}">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Discount" aria-label="Discount" aria-describedby="basic-addon2" name="discount" value="{{ $product->discount }}">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="customRadioInline1" name="customRadioInline1" class="custom-control-input" value='1' active>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input" value='0' active>
                                                <label class="custom-control-label" for="customRadioInline2">Inactive</label>
                                            </div>
                                            @endif
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <textarea class="form-control" rows="4" name="product_description">{{ $product->p_description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--/row-->
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="btn btn-info waves-effect waves-light"><span>Upload Anonther Image</span>
                                            ...
                                            <input type="hidden" name="img_url" value="{{ $product->product_image}}">
                                    </div>
                                </div>
