                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('types.store')}}" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                <h5 class="card-title">About Type</h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Type Name</label>
                                            <input type="text" id="firstName" class="form-control"  name="type_name" placeholder=""> </div>
                                    </div>
                            ...
                            <!--         <div class="col-md-6">
                             ...
                             <!--            <div class="el-element-overlay">
                                        ...
                                        <div class="btn btn-info waves-effect waves-light"><span>Upload Anonther Image</span>
                                            <input type="file" class="upload" name="type_image"> </div>
                                    </div>
                                </div>
                   <!--              <div class="row">
                                    <div class="col-md-12">
