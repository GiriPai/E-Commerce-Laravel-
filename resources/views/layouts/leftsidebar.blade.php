            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="Userdd">
                                       ...
                                       <!-- <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                        <a ><i class="ti-settings m-r-5 m-l-5"></i> Logout</a>
                                        @csrf
                                        </form> -->
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="http://themedesigner.in/demo/wrappixel/admin-template/xtreme/docs/documentation.html" aria-expanded="false"><i class="mdi mdi-content-paste"></i><span class="hide-menu">Documentation</span></a></li>
